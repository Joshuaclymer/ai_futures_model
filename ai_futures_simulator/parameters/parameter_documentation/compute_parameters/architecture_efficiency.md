...
![TPP per die area over time](/parameter_docs/compute_parameters/tpp_per_die_area.png)

Transistor density has increased at approximately 1.26x per year:

![Transistor density over time](/parameter_docs/compute_parameters/transistor_density_over_time.png)
