...
export const CombinedComputeChart = memo<CombinedComputeChartProps>(({ chartData, className, title = 'Effective & Training Compute', height, width, domainOverride, verticalReferenceLine, displayEndYear, showTrainingSeries = true, sampleTrajectories = [], isLoading = false }) => {
  ...
  return (
    ...
    >
      <div className="flex gap-2 items-center">
        ...
        <WithChartTooltip explanation={COMPUTE_CHART_EXPLANATION} className="!gap-0" isLoading={isLoading}><></></WithChartTooltip>
      </div>
      <CustomLineChart
        data={mergedData}
        height={height ?? 239}
