...
export interface AIRAndDProgressMultiplierChartProps {
...
export const AIRAndDProgressMultiplierChart = memo(({
  chartData,
  tooltip,
  milestones,
  displayEndYear,
  ...
  sampleTrajectories = [],
}: AIRAndDProgressMultiplierChartProps) => {
  ...
  const customElements = useMemo(() => {
    ...
    MilestoneOverlay.displayName = 'AIRAndDMilestoneOverlay';
...
AIRAndDProgressMultiplierChart.displayName = 'AIRAndDProgressMultiplierChart';
