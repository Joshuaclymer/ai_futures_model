...
def calculate_initial_research_stock(time_series_data: TimeSeriesData, params: Parameters,
    ...
    try:
        ...
        if params.human_only:
            coding_labor_0 = compute_coding_labor_deprecated(None, inference_compute_0, L_HUMAN_0, params.rho_coding_labor, params.parallel_penalty, params.coding_labor_normalization, human_only=True)
            ...
            coding_labor_0 = compute_coding_labor_deprecated(
        ...
        if params.human_only:
            coding_labor_dt = compute_coding_labor_deprecated(None, inference_compute_dt, L_HUMAN_dt, params.rho_coding_labor, params.parallel_penalty, params.coding_labor_normalization, human_only=True)
            logger.info(f"HUMAN-ONLY::: coding_labor_dt: {coding_labor_dt}")
        else:
            coding_labor_dt = compute_coding_labor_deprecated(
...
def integrate_progress_human_only(
    ...
    training_compute_growth_rate_fine = np.interp(internal_times, data.time, data.training_compute_growth_rate)
