...
from initialize.world_states import initialize_world_states
from update.world_state import WorldStateUpdator
...
class AIFuturesSimulator:
    ...
    def run_simulation(self, simulation_parameters: SimulationParameters) -> SimulationRun:
        ...
        world_state_updator = WorldStateUpdator(
        ...
        for time in range(start_time, end_time + increment, increment):
            next_world_state = world_state_updator.get_next_world_state()
