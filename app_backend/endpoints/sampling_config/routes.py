"""Sampling configuration endpoint."""
...
def register_sampling_config_routes(app):
    """Register sampling config route with the Flask app."""
    ...
    def get_sampling_config():
        ...
        try:
            ...
            mc_config_path = Path(__file__).resolve().parent.parent.parent.parent / "ai_futures_simulator" / "parameters" / "default_parameters.yaml"
