...
# Cache configuration - enabled by default, set USE_CACHE=false in env to disable
...
def register_black_project_routes(app):
    ...
    def get_data_for_ai_black_projects_page():
        ...
        Request body:
        {
            ...
            "ai_slowdown_start_year": 2030,  // Year when AI slowdown agreement takes effect
        ...
        try:
            ...
            ai_slowdown_start_year = data.get('ai_slowdown_start_year', 2030)
