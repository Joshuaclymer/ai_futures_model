...
# Parallel labor multiplier between average and top for AI2027-SC milestone
# Formula: 30^(1/parallel_penalty) * 30 * PARALLEL_LABOR_MULT_BETWEEN_AVERAGE_AND_TOP_FOR_AI2027_SC
...
TASTE_SLOPE_DEFAULTS = {
    "SDs per effective OOM": 1.47, # this is out of date since unused
    "SDs per progress-year": 2.1
}
...
# SIE (Software Intelligence Explosion) Mode Configuration
# Available milestones for SIE mode start point
SOS_START_MILESTONES = ["AC", "AI2027-SC", "AIR-5x", "AIR-25x", "AIR-250x", "AIR-2000x", "AIR-10000x"]
DEFAULT_SOS_START_MILESTONE = "AC"

# Manual Horizon Fitting Parameters
DEFAULT_present_day = 2025.9 # GPT-5.1-codex-max
DEFAULT_present_horizon = 32  # Will be optimized if None
...
CAPABILITY_POINTS_PER_OOM = 9.6 # (15.5 pt/year) / (1.6 OOM/yr) 
...
PARAMETER_BOUNDS = {
    ...
    'automation_logistic_asymptote': (1.0001, 100.0),  # Upper asymptote for logistic schedule
    ...
    'ac_time_horizon_minutes': (960, 100000000000),
...
DEFAULT_PARAMETERS = {
    ...
    'swe_multiplier_at_present_day': 1.8,
    'automation_interp_type': "logistic",
    'automation_logistic_asymptote': 1.1,  # Upper asymptote for logistic coding automation schedule (clipped to 1)
    'coding_labor_normalization': 1, # unused
    ...
    'progress_at_aa': None,
    'ac_time_horizon_minutes': 1.5e7, # 125 work years
    ...
    'ted_ai_m2b': 1.5,    # TED-AI median-to-bests above SAR (ASI is always 2 M2Bs above TED-AI)
    ...
    # SOS mode
    'sos_mode': False,
    'sos_start_milestone': DEFAULT_SOS_START_MILESTONE,
    'plan_a_mode': False,
    'is_blacksite': False,
...
PLOT_METADATA = {
    ...
    'plot_ai_only_coding_labor': {
        'title': 'AI-Only Coding Labor',
        'x_axis': {'title': 'Time', 'type': 'linear'},
        'y_axis': {'title': 'Nonsense units', 'type': 'log'},
        'data_keys': ['times', 'ai_only_coding_labors']
    },
    ...
    'plot_mrts_exp_compute_human_labor': {
        'title': 'MRTS: Experiment Compute per Human',
        'x_axis': {'title': 'Time', 'type': 'linear'},
        'y_axis': {'title': 'Experiment Compute per Human (log scale)', 'type': 'log'},
        'data_keys': ['times', 'mrts_exp_compute_human_labor']
    },
    'plot_ai_sw_uplift_doubling_time': {
        'title': 'AI SW Uplift Doubling Time vs Uplift',
        'x_axis': {'title': 'AI SW Progress Multiplier (log scale)', 'type': 'log'},
        'y_axis': {'title': 'Doubling Time (years, log scale)', 'type': 'log'},
        'data_keys': ['ai_sw_progress_mult_ref_present_day', 'ai_sw_uplift_doubling_times']
    },
    'plot_optimal_training_run_length': {
        'title': 'Optimal Training Run Length',
        'x_axis': {'title': 'Time', 'type': 'linear'},
        'y_axis': {'title': 'Years', 'type': 'linear'},
        'data_keys': ['times', 'optimal_training_run_length']
    }
}
...
Average of the research taste distribution, after replacing sub-AI human researchers with AI researchers.
    ...
    'coding_labor': {
        ...
        'plots': [
            ...
            {'function': 'plot_ai_only_coding_labor', 'position': (4, 1)}
        ],
        'explanation': """
...
### AI-Only Coding Labor (Bottom Row)
Shows what coding labor would be if only AI (no humans) were doing the work. This is 0 when automation fraction < 1, since AI can only do tasks up to the automation fraction boundary. Once automation fraction reaches 1 (full automation), this shows the AI-only coding labor using the CES frontier formula.
        """
    },
    'research_effort': {
        'id': 'research-effort',
        ...
        'plots': [
            ...
            {'function': 'plot_mrts_exp_compute_human_labor', 'position': (3, 1)}
        ],
        'explanation': """
...
### MRTS: Experiment Compute per Human (Bottom Left)
The Marginal Rate of Technical Substitution (MRTS) between experiment compute and human labor shows how many units of experiment compute one additional human researcher provides at the margin (keeping experiment capacity constant). This metric uses the human-only serial coding labor (no AI contribution).
        """
    },
    'software_rd': {
        'id': 'software-rd',
...
This tab shows the model's capability measured using the ECI (Effective Compute Index) score over time. The ECI score is calculated based on training compute and software efficiency.
    ...
    'other_metrics': {
        ...
        'plots': [
            ...
            {'function': 'plot_ai_sw_uplift_doubling_time', 'position': (6, 1)},
            {'function': 'plot_optimal_training_run_length', 'position': (6, 2)},
        ],
        'explanation': """
